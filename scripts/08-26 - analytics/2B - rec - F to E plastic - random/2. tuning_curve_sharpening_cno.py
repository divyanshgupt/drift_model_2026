...
def generate(cno_inh_input_scales, seed, hebb_k, eta_k,
    ...
    for input_idx, cno_inh_input_scale in enumerate(cno_inh_input_scales):
        ...
        tuning_curves_neuron[input_idx, :] = network.tuning_curves_over_days[day][int(N//2), :]
        tuning_widths_neuron[input_idx, :] = network.tuning_widths_over_days[day][int(N//2)]
...
if __name__ == "__main__":
    ...
    save_loc = "../../../results/08-26 - analytics/2A - rec - F to E plastic - cotuned/2. tuning_curve_sharpening_cno/"
    ...
    if args.stage == "plot":
        ...
        fig.suptitle("Recurrent - F to E plastic - cotuned")
        fig.tight_layout()
