...
if __name__ == "__main__":
    ...
    save_loc_general = "../../results/08-07 - complete single simulations/1 - FF - cotuned - inh_mod/"
    ...
    if args.stage == "generate":
        generate(seeds, hebb_k, eta_k, n_days, N, cno_inh_input_scale, baseline_inh_input_scale, save_loc_sim)
        ...
        (baseline_drift_mag, baseline_drift_rate,
            ...
            baseline_tuning_over_days, cno_tuning_over_days) = load_data(save_loc_sim, seeds, n_seeds, n_days, N, n_theta)
