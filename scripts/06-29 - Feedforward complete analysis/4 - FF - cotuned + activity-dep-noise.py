...
save_loc_general = "../../results/06-29 - Feedforward complete analysis/4 - FF - cotuned + activity-dep-noise/"
if not os.path.exists(save_loc_general):
    os.makedirs(save_loc_general)


net_inh_1 = Feedforward(inh='on', inh_type='co-tuned', 
                        train_sigma=25, inh_scale=0.6,
                        activity_dependent_noise=True)
net_inh_1.run_analysis(save_results=True,
                       saveloc=save_loc_general + "inh_scale_0.6/")

net_inh_2 = Feedforward(inh='on', inh_type='co-tuned',
                        train_sigma=25, inh_scale=0.8,
                        activity_dependent_noise=True)
net_inh_2.run_analysis(save_results=True,
                       saveloc=save_loc_general + "inh_scale_0.8/")

net_inh_3 = Feedforward(inh='on', inh_type='co-tuned',
                        train_sigma=25, inh_scale=1.0,
                        activity_dependent_noise=True)

net_inh_3.run_analysis(save_results=True,
                       saveloc=save_loc_general + "inh_scale_1.0/")

# load hdf5 files for the three networks and extract drift metrics
file_1 = save_loc_general + "inh_scale_0.6/" + "results.h5"
file_2 = save_loc_general + "inh_scale_0.8/" + "results.h5"
file_3 = save_loc_general + "inh_scale_1.0/" + "results.h5"
...
labels = ["inh_scale_0.6", "inh_scale_0.8", "inh_scale_1.0"]
