...
save_loc_general = "../../results/06-29 - Inh plasticity/1. rec static + inh hebb/"
...
net_inh_1 = BaselineNetwork(inh_type="co-tuned", E_to_E="on", E_to_I="on", I_to_I="on",
                      plasticity_E_to_E="off", plasticity_E_to_I="off", plasticity_I_to_E="off", plasticity_I_to_I="on",
